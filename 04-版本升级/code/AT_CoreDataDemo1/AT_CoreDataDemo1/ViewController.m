...
- (void)viewDidLoad {
    ...
    // 更新数据源 查询数据
    NSFetchRequest *req  = [NSFetchRequest fetchRequestWithEntityName:@"NewStudent"];
...
- (void)createDB
{
    ...
    [storeCoord addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:[NSURL fileURLWithPath:sqlPath] options:dic error:&error];
...
- (IBAction)insertAction:(UIButton *)sender {
    ...
    NewStudent *stu = [NSEntityDescription insertNewObjectForEntityForName:@"NewStudent" inManagedObjectContext:_context];
...
- (IBAction)orderAction:(UIButton *)sender {
    ...
    //创建排序请求
    NSFetchRequest *request = [NSFetchRequest fetchRequestWithEntityName:@"NewStudent"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NewStudent *stu = _dataSource[indexPath.row];
    cell.textLabel.text = [NSString stringWithFormat:@"%@---年龄:%d--%@",stu.name,stu.age,stu.sex];
